...
1. เพิ่มท่าออกกำลังกายอื่นๆ เช่น Lunges, Planks, Deadlifts
2. พัฒนาเป็น Web Application ด้วย TensorFlow.js
3. เพิ่ม Multi-person Tracking
4. ใช้ Transformer-based Model แทน LSTM
5. เพิ่มระบบ Gamification (แต้ม, ระดับ, ลีดเดอร์บอร์ด)
